  ...
  try {
    ...
    for (const film of movies) {
      try {
        ...
        const providersForMovie = {
          ...
          US: providersData.US ? {
            types: {
              ...
              rent: providersData.US.rent?.map((provider) => [provider.provider_name, provider.logo_path]) || [],
          ...
          UK: providersData.UK ? {
            types: {
              ...
              rent: providersData.UK.rent?.map((provider) => [provider.provider_name, provider.logo_path]) || [],
        ...
        console.error(`❌ Error fetching data for movie ID ${film.id}:`, error.message);
